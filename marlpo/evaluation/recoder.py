...
class RecorderEnv(Wrapper):
    ...
    _default_eval_config = dict(neighbours_distance=40)
    ...
    def reset(
        ...
        *,
        ...
        # obs_and_infos = super(RecorderEnv, self).reset()
        obs_and_infos = self.env.reset(seed=seed)
        self.episode_step = 0
        return obs_and_infos

    def step(self, actions):
        o, r, tm, tc, i = super(RecorderEnv, self).step(actions)
        self.on_episode_step(o, r, tm, tc, i)
        for kkk, ddd in tm.items():
            if kkk != "__all__" and ddd:
                self.on_episode_end(kkk, o, r, tm, tc, i)
        return o, r, tm, tc, i
    ...
    def on_episode_step(self, o, r, tm, tc, i):
        ...
        if hasattr(self.unwrapped, "vehicles_including_just_terminated"):
    ...
    def on_episode_end(self, kkk, o, r, tm, tc, i):
        info = i[kkk]
    ...
    def render(
        ...
        **kwargs
        ...
        if mode in ["top_down", "topdown", "bev", "birdview"]:
            return self.env.render(text=text, mode=mode, *args, **kwargs)
        else:
